...
//     {
//       boundary_name: "red",
//       lower_boundary: props.data?.RedLower ?? 0,
//       upper_boundary: props.data?.RedUpper ?? 0,
//       weight: props.data?.RedWeight ?? 0,
//     },
//     {
//       boundary_name: "orange",
//       lower_boundary: props.data?.OrangeLower ?? 0,
//       upper_boundary: props.data?.OrangeUpper ?? 0,
//       weight: props.data?.OrangeWeight ?? 0,
//     },
//     {
//       boundary_name: "yellow",
//       lower_boundary: props.data?.YellowLower ?? 0,
//       upper_boundary: props.data?.YellowUpper ?? 0,
//       weight: props.data?.YellowWeight ?? 0,
//     },
//     {
//       boundary_name: "light green",
//       lower_boundary: props.data?.LightGreenLower ?? 0,
//       upper_boundary: props.data?.LightGreenUpper ?? 0,
//       weight: props.data?.LightGreenWeight ?? 0,
//     },
//     {
//       boundary_name: "green",
//       lower_boundary: props.data?.GreenLower ?? 0,
//       upper_boundary: props.data?.GreenUpper ?? 0,
//       weight: props.data?.GreenWeight ?? 0,
//     },
//   ],
//   compare_curriculum_pk: props.data?.compare_curriculum_pk,
//   primary_curriculum_pk: props.data?.primary_curriculum_pk,
// };
...
//   if (
//     value >= props.data.bodyData.boundary[0].lower_boundary &&
//     value <= props.data.bodyData.boundary[0].upper_boundary
//   ) {
//     return "bg-red-200";
//   } else if (
//     value >= props.data.OrangeLower &&
//     value <= props.data.OrangeUpper
//   ) {
//     return "bg-orange-200";
//   } else if (
//     value >= props.data.YellowLower &&
//     value <= props.data.YellowUpper
//   ) {
//     return "bg-yellow-200";
//   } else if (
//     value >= props.data.LightGreenLower &&
//     value <= props.data.LightGreenUpper
//   ) {
//     return "bg-lime-200";
//   } else if (
//     (value >= props.data.GreenLower && value <= props.data.GreenUpper) ||
//     value === "<= 0.1"
//   ) {
//     return "bg-green-200";
//   } else {
...
// const getSimilality = async () => {
//   try {
//     await $fetch(
//       `http://127.0.0.1:8000/similarities/sum-of-ratio-multiplied-by-weight`,
//       {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
